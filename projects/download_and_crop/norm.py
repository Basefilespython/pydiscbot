...
try:
  import plyer
  py_logger.info(f"Import module [plyer] successfully.")
except:
  system("pip install plyer")
  try:
    import plyer
    py_logger.info(
      f"Import module [plyer] failed -> Import module [plyer] successfully.")
  except ModuleNotFoundError:
    py_logger.error("Import module [plyer] failed.")
